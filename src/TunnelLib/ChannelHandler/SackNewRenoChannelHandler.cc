...
SackNewRenoChannelHandler::SackNewRenoChannelHandler(BaseReliableObj *parent, appInt8 ifcLoc, RemoteAddr &rmadr, appInt8 ifcSrc, appInt8 ifcDst, bool lock) :
        BasicChannelHandler(parent, ifcLoc, rmadr, ifcSrc, ifcDst, lock)
        , multiRecoverIndex(0)
        , recoverIndex(0)
{
...
appSInt SackNewRenoChannelHandler::sendSeq(appInt16 seq) {
    sendSeqLock.lock();
