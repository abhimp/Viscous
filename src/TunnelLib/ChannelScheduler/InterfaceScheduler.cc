...
InterfaceScheduler::InterfaceScheduler(BaseReliableObj *parent, appBool doNotAddChannel) : BaseReliableObj(parent)
        , interfaces()
        , nextInterfaceId(0)
        , next(0)
        , packetBuffer(512)
...
appSInt InterfaceScheduler::recvPacketFrom(Packet *pkt, RecvSendFlags &flags)
{
...
appStatus InterfaceScheduler::closeFlow(appFlowIdType flowId)
{
    APP_RETURN_FAILURE
}
...
void InterfaceScheduler::interfaceAdded() {
}

void InterfaceScheduler::interfaceRemoved(appInt8 ifcId) {
}
