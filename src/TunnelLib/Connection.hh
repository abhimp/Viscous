...
public:
    Connection(BaseReliableObj *parent);
    virtual ~Connection(){};
    virtual appSInt sendPacketTo(appInt id, Packet *pkt);
    virtual appSInt recvPacketFrom(Packet *pkt, RecvSendFlags &flags) {APP_ASSERT_MSG(1, "YOU SHOULD NOT CALL IT. CHECK YOUR CODE\n"); return 0; };
...
//    virtual void dataRecvCb(EV_P_ ev_io *w, int revents);
    virtual appStatus reset(appFlowIdType flowid){APP_ASSERT("INVALID CALL" && 0); return APP_SUCCESS;};
